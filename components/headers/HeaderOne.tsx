...
import { openModal } from "@/store/slices/mobileSearchSlice";
      ...
      <div className="max-w-screen-xl mx-auto  p-4 md:py-4 md:px-8 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-6 ">
          ...
          <div className="lg:hidden text-center">
            <Search size={25} onClick={() => dispatch(openModal())} />
          </div>
          {/* desktop search */}
          ...
          <div className="flex items-center gap-6 lg:gap-2 lg:-mt-1">
            ...
            {!user && (
              <a
                href="/auth/login"
                className="hidden lg:inline-block text-sm font-medium bg-gray-200 dark:bg-gray-800 px-4 py-2 rounded-full hover:bg-gray-300 dark:hover:bg-gray-700"
              >
                Ingresar
              </a>
            )}
